        ...
        style={{borderRadius: isInView? "10%":"50%"}}>
            ...
            style={{opacity: isInView? "1": "0.3"}}>
                ...
                <div className="flex justify-between w-full mb-2 md:mb-10 md:mt-3">
                    <h4 className="font-subtitle text-[16px] md:text-[20px]">Weekdays </h4>
                    <h4 className="font-subtitle text-[14px] md:text-[20px] md:hidden">10AM - 7:30PM </h4>
                    <h4 className="hidden font-subtitle text-[18px] md:text-[20px] md:block">10:00AM - 07:30PM </h4>
                </div>

                <div className="flex justify-between w-full mt-2 mb-2 md:mb-10">
                    <h4 className="font-subtitle text-[16px] md:text-[20px]">Saturday </h4>
                ...
                <div className="flex justify-between w-full mt-2 md:mb-10">
                    <h4 className="font-subtitle tracking-tighter text-[16px] md:text-[20px]">Sunday & Holidays </h4>
