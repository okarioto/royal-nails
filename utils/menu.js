...
const add_ons = {
    ...
    items: [{ name: "Add Gel Polish", price: "$17 & up" }, , { name: "Gel Polish Change", price: "$32 & up" }, { name: "Polish Change", price: "$15 & up" }, { name: "Nail Cut", price: "$12 & up" }, { name: "Acrylic/Gel/Solar Take Off", price: "$22 & up" }, { name: "Paffin Hand Treatment", price: "$10" }, { name: "Paffin Feet Treatment", price: "$15" }]
}
